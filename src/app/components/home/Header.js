    ...
    >
      ...
      <div className="relative flex-1 flex items-center justify-between">
        <Link href="/" className="flex items-center">
          <img
            ...
            alt="Logo"
            className="h-14 transition-transform duration-300 hover:scale-110 hidden md:block"
          />
        </Link>
      </div>
      ...
      >
        <nav className="flex items-center justify-between w-full">
          <ul className={`md:flex items-center justify-between text-base pt-4 md:pt-0 ${isScrolled ? 'text-gray-800' : 'text-white'}`}>
            <li>
              <a
            ...
            >
              ...
              >
                Category
                <svg
                  className="w-4 h-4 text-inherit transition"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              {isCategoryOpen && (
                <div className="absolute top-12 left-0 bg-white shadow-lg rounded-lg mt-2 w-56 z-50 border border-gray-100">
                  <ul className="flex flex-col text-gray-700 divide-y divide-gray-100">
                    <li>
                      <a href="/category/new-arrivals" className="flex items-center px-5 py-3 hover:bg-amber-50/80 transition-all duration-200 group text-gray-800 hover:text-amber-700 font-medium">
                    ...
                    <li>
                      <a href="/category/denim" className="flex items-center px-5 py-3 hover:bg-amber-50/80 transition-all duration-200 group text-gray-800 hover:text-amber-700 font-medium">
                        <svg className="w-5 h-5 mr-3 text-gray-400 group-hover:text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                      <a href="/category/tops" className="flex items-center px-5 py-3 hover:bg-amber-50/80 transition-all duration-200 group text-gray-800 hover:text-amber-700 font-medium">
                        <svg className="w-5 h-5 mr-3 text-gray-400 group-hover:text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                      <a href="/category/alt-products" className="flex items-center px-5 py-3 hover:bg-amber-50/80 transition-all duration-200 group text-gray-800 hover:text-amber-700 font-medium">
                        <svg className="w-5 h-5 mr-3 text-gray-400 group-hover:text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="ml-2 flex items-center space-x-4 mt-4 md:mt-0 cursor-pointer relative">
            <button
              ...
              className={`transition-colors duration-300 ${isScrolled ? 'text-gray-800 hover:text-blue-500' : 'text-white hover:text-blue-300'}`}
            >
